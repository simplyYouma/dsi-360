...
REM  console correcte puis delegue a infra\local\exploitation\demarrer-dev.ps1.
REM
...
REM
REM  Les arguments sont transmis tels quels :  DEMARRER-DSI360.bat -SansOuvrir
REM ===========================================================================
...
REM sinon Windows PowerShell 5.1 : demarrer-dev.ps1 se relance lui-meme sous pwsh.
set "PS_EXE="
...
"%PS_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0infra\local\exploitation\demarrer-dev.ps1" %*
set "CODE=%ERRORLEVEL%"
